...
var BalanceDetailComponent = /** @class */ (function () {
    function BalanceDetailComponent(restApi) {
    ...
    BalanceDetailComponent.prototype.loadTransaction = function () {
        var _this = this;
        return this.restApi.getTransactions().subscribe(function (data) {
            _this.Transaction = data;
        });
    };
    BalanceDetailComponent.ctorParameters = function () { return [
...
var TransactionMenuComponent = /** @class */ (function () {
    function TransactionMenuComponent() {
    }
    TransactionMenuComponent.prototype.ngOnInit = function () {
    };
    ...
    return TransactionMenuComponent;
}());
...
var TransactionComponent = /** @class */ (function () {
    function TransactionComponent(route, restApi, router) {
        this.route = route;
        this.restApi = restApi;
        this.router = router;
    ...
    TransactionComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route.params.subscribe(function (params) {
            ...
            _this.transactionDetails.transactionType = _this.type;
        });
    };
    TransactionComponent.prototype.addTransaction = function () {
        var _this = this;
        this.transactionDetails.amount = +this.transactionDetails.amount;
        this.restApi.createTransaction(this.transactionDetails).subscribe(function (data) {
